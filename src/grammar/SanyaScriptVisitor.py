...
class SanyaScriptVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by SanyaScriptParser#defvar.
    def visitDefvar(self, ctx:SanyaScriptParser.DefvarContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by SanyaScriptParser#arc.
    def visitArc(self, ctx:SanyaScriptParser.ArcContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by SanyaScriptParser#value.
    def visitValue(self, ctx:SanyaScriptParser.ValueContext):
        return self.visitChildren(ctx)
